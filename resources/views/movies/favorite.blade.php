...
<section class="listing text-white" style="min-height: 100vh; padding:8% 0;">
    ...
    <div class="container">
        ...
        <h2 class="fw-300">Favorite Movies</h2>

        <div class="row">

            @forelse ($movies as $movie)

            <div class="col-md-3 movie my-3 " id="favorite-{{ $movie->id }}">
                ...
                <div class="movie__details text-white px-2">
                    ...
                    <div class="d-flex movie__cta">
                        ...
                        <i data-url="{{ route('movies.toggle_favorite', $movie->id ) }}"
                            ...
                            class="fa fa-lg {{ in_array($movie->id, $favorite_movies) ? 'fa-heart' : 'fa-heart-o' }}
                            align-self-center movie__fav-button movie-{{ $movie->id }} favorite-movie
                            ">
                        </i>
                        @else
            ...
            <div class="col">
                <h5 class="fw-300">Sorry! no favorite movies found</h5>
            </div>
